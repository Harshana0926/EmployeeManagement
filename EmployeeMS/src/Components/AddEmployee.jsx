...
const AddEmployee = () => {
  const [employee, setEmployee] = useState({
    ...
    address: "",
    category_id: "",
    image: null, // Ensure it's initially null
  });
  ...
  const handleSubmit = (e) => {
    ...
    // Form validation can be added here, ensuring required fields are not empty
    ...
    formData.append('image', employee.image); // Add image file
